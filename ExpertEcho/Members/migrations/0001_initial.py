    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_field', models.CharField(choices=[('field1', 'Finance'), ('field2', 'Economics'), ('field3', 'Law'), ('field4', 'Medicine'), ('field5', 'Technology')], default='None Selected', max_length=20)),
